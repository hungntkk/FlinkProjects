...
//
//        GenericRecord result = fromJasonToAvro(json,schemastr);
//
...
//    }
     ...
     * @throws Exception
     */
    public static GenericRecord fromJasonToAvro(String json, String schemastr) throws Exception {

        byte[] avroByteArray = fromJasonToByteArray(json,schemastr);
     ...
     * @throws Exception
     */
    static byte[] fromJasonToByteArray(String json, String schemastr) throws Exception {
