...
public class KafkaToParquet {
    public static void main(String[] args) throws Exception {
        ...
        // code này e copy y hệt mà lỗi kryo nên e chuyển qua cách viết mới ở dưới
        ...
        //            return rec;
        //        });
        // Hàm này bị lỗi not serializable, nên em chuyển qua POJOs trước rồi mới put vô mà vẫn lỗi y hệt như vậy
        DataStream <GenericRecord> records = kafkaData
...
//
        final StreamingFileSink<GenericRecord> sink = StreamingFileSink
                .forBulkFormat(new Path("/home/prophet/Flink/data/parquet2"), ParquetAvroWriters.forGenericRecord(schema))
                .build();
